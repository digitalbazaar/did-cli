 ...
 *
 * @returns {Promise<{anchoredResource: object}>} - Resolves with the
 *   `anchoredResource` object (useful for cutting and pasting into a VC).
 */
export async function create({
  ...
  anchoredResource.contentHash = {digestMultibase: contentHash};
  if(parsed) {
